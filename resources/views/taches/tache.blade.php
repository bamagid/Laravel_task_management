                ...
                <div class="card mx-6" style="width: 18rem; height: 20rem; margin-top:20px;">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="/taches/{{$tache->id}}/details" class="card-link btn btn-primary primary">Détails</a>
                            <a href="/taches/modifier/{{$tache->id}}" class="card-link btn btn-info info">Modifier</a>
                        </div>
                    </div>
                </div>
            </div>
